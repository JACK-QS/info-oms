    ...
    methods: {
        ...
        handleEdit: function(row) {
            ...
            layer.open({
                ...
                shadeClose: false, // 点击遮罩关闭层
                area: ['800px', '520px'],
                content: context + 'role/update?roleName='+row.roleName+"&roleAuthoritr="+row.roleAuthoritr+"&roleId="+row.roleId, // iframe的url
                end: function () {
                    vm.getRoleList();
                }
            });
        ...
        handleDelete:function(row,tableData) {
            layer.confirm("您确定要删除吗？", function (index) {
                $.ajax({
                    url: context + 'role/deleteRole?roleId=' + row.roleId,
                    type: 'GET',
